...
A circle geofence is a radius around a location point. To create a circle geofence the **required body parameters** are _\*\*_ `coordinates`, and `geometry_radius` .
